...
public class TaxonSetsPanel extends JPanel implements Exportable {
	...
	public TaxonSetsPanel(TreeStatFrame frame, TreeStatData treeStatData) {
		...
		Icon addIcon = null, removeIcon = null, includeIcon = null, excludeIcon = null;
 		try {
			addIcon = new ImageIcon(beast.app.util.Utils.getImage(this, "images/add.png"));
			removeIcon = new ImageIcon(beast.app.util.Utils.getImage(this, "images/minus.png"));
			includeIcon = new ImageIcon(beast.app.util.Utils.getImage(this, "images/include.png"));
			excludeIcon = new ImageIcon(beast.app.util.Utils.getImage(this, "images/exclude.png"));
		} catch (Exception e) {
			// do nothing
		}
