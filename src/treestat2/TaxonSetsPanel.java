...
public class TaxonSetsPanel extends JPanel implements Exportable {
	...
	public TaxonSetsPanel(TreeStatFrame frame, TreeStatData treeStatData) {
		...
		Icon addIcon = null, removeIcon = null, includeIcon = null, excludeIcon = null;
 		try {
			addIcon = new ImageIcon(CharactersPanel.getImage(this, "images/add.png"));
			removeIcon = new ImageIcon(CharactersPanel.getImage(this, "images/minus.png"));
			includeIcon = new ImageIcon(CharactersPanel.getImage(this, "images/include.png"));
			excludeIcon = new ImageIcon(CharactersPanel.getImage(this, "images/exclude.png"));
		} catch (Exception e) {
			// do nothing
		}
