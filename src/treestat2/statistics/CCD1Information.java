...
@SummaryStatisticDescription(
        name = "CCD1 information content (log(p))",
        description = "The information content of each sampled tree T of the sample given by log(Pr(T)) where Pr(T) is the probability of T in the CCD1.",
