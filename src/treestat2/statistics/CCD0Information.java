...
@SummaryStatisticDescription(
        name = "CCD0 information content (log(p))",
        description = "The information content of each sampled tree T of the sample given by log(Pr(T)) where Pr(T) is the probability of T in the CCD0.",
...
public class CCD0Information extends AbstractTreeSummaryStatistic<Double> {
	...
	public Double[] getSummaryStatistic(Tree tree) {
        ...
        double p = ccd0.getProbabilityOfTree(tree);
