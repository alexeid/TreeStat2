...
@SummaryStatisticDescription(
        name = "CCD1 RF distance",
        description = "The Robinsons-Fould (RF) distance computed by using CCD1 (observed clade splits) point estimator for tree distribution.",
...
public class CCD1RFDistance extends AbstractTreeSummaryStatistic<Integer> implements CCDStats<Integer> {

    @Override
	public Integer[] getSummaryStatistic(Tree tree) {

        WrappedBeastTree mapTree = TreeStatUtils.getCCDHandler().getMapTreeCCD1();
